export function Rodape() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col md:flex-row justify-between w-full max-w-5xl mx-auto mt-4 text-left p-10 gap-8"
        aria-labelledby="titulo-rodape"
      >
        <div className="flex flex-row justify-center gap-20 pl-35">
          {/* Institucional */}
