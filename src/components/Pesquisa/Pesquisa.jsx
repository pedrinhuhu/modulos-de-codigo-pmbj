  ...
  return (
    ...
    >
      <div className="p-6 md:p-10">
        ...
        >
          <fieldset className="flex flex-col md:flex-row gap-3 md:gap-4 border-none p-0 m-0 w-full">
            <legend className="sr-only">Filtros de pesquisa</legend>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            {selectedTags.length > 0 && (
              <button
                type="button"
                onClick={limparTags}
                className="text-xs text-gray-500 hover:text-red-500 transition focus:outline-none focus:ring-2 focus:ring-[#1351B4] rounded"
          ...
          {selectedTags.length > 0 && (
            <div className="mt-5 pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-500 mb-2">Filtrando por:</p>
