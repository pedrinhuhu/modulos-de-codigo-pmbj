...
export function PaginaAcessibilidade() {
  return (
    <>
      <Breadcrumb
        items={[{ label: "Início", href: "/" }, { label: "Acessibilidade" }]}
      />
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <ul className="space-y-6" aria-labelledby="funcionalidades">
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                a opção de redefinir para o tamanho padrão (16px) a qualquer
                momento.
              </p>
            </li>
            ...
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                vocaliza automaticamente os elementos da página conforme você
                navega. Quando ativado, o sistema lê títulos, textos, rótulos e
                placeholders dos campos, auxiliando pessoas com deficiência
            ...
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                ...
                digitais (texto, áudio e vídeo) para a Língua Brasileira de
                Sinais (Libras), tornando o site acessível para pessoas surdas
                ou com deficiência auditiva.
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                <strong className="text-gray-800">Como usar:</strong> Localize o
                ícone do VLibras no canto inferior direito da página (próximo ao
                botão de acessibilidade). Clique sobre ele para ativar o avatar
                virtual que fará a tradução em Libras do conteúdo selecionado.
              </p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-gray-800">Dica:</strong> Você pode
                selecionar qualquer texto da página e clicar no avatar para
                visualizar a tradução em Libras. O VLibras também permite
                ajustar a velocidade e o tamanho do avatar conforme sua
                preferência.
              </p>
            </li>
            ...
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed">
                As funcionalidades de ajuste de fonte, alto contraste e leitor
                de tela estão disponíveis através do botão flutuante de
                acessibilidade (ícone de pessoa) localizado no canto inferior
                direito de todas as páginas. Ao clicar, um menu será aberto com
            ...
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                O site é totalmente navegável por teclado, permitindo que
                usuários que não utilizam mouse possam acessar todos os
                recursos. Utilize as seguintes teclas de atalho:
              </p>
            ...
            <li className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1351B4]">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                contraste e leitor de tela) são salvas automaticamente e
                permanecerão ativas em suas próximas visitas ao site, garantindo
