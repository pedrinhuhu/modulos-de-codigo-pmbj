  ...
  return (
    ...
    >
      ...
      <header className="mb-8">
        <h1 className="text-2xl font-semibold text-[#1351B4]">Painel Administrativo</h1>
        <p className="text-sm text-gray-500 mt-1">
          Gerencie as publicações do Diário Oficial do Município de Bom Jardim.
        </p>
      </header>
        ...
        {pdfs.length === 0 ? (
          ...
          >
            {pdfs.map((pdf) => (
              ...
              >
                <FileText size={28} className="mb-3 text-[#1351B4]" aria-hidden="true" />
